...
| d                | Next image                                             |
+------------------+--------------------------------------------------------+
| t                | Use tracker to track selected rectangle                |
+------------------+--------------------------------------------------------+
| a                | Previous image                                         |
+------------------+--------------------------------------------------------+
...
| Ctrl--           | Zoom out                                               |
+------------------+--------------------------------------------------------+
| ↑→↓←             | Keyboard arrows to move selected rect box 1 px         |
+------------------+--------------------------------------------------------+
| ctrl ↑→↓←        | Keyboard arrows to move selected rect box 10 px        |
+------------------+--------------------------------------------------------+
| shift ↑→↓←       | Expand bbox in each direction                          |
+------------------+--------------------------------------------------------+
| ctrl +shift ↑→↓← | Contract bbox in each direction                        |
+------------------+--------------------------------------------------------+
